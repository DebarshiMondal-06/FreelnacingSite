...
<body style="background-color:#E8E8E8">
	...
	<div class="welcome-title">
		...
		<h6>Find top Specialists on INIESTA-Freelancing —
			the Best freelancing website for short-term, <br> recurring, and full-time contract work.</h6>
			<br>
	  ...
	  <main class="display">
  	<section class="card p-2 shadow border">
		<div  class="wistia_embed wistia_async_d0xztqofsq seo=false" style="height:300px;position:relative;width:500px">
		...
		<div class="container-fluid body-section" style="padding-top: 4%;">
			...
			<div class="category-container row">
				<div class="category-card col-sm-3">
					<a class="bloglink" href="index.php">
						<div class="card">
